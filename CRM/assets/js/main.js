...
$('#btncollapzion').Collapzion({
    _child_attribute: [{
        ...
        {
            'label': ' پدیده بگ در اینستاگرام',
            'url': 'https://instagram.com/padidehbags',
            'icon': 'bi bi-instagram'
        },
  {


      'label': 'واتس آپ پدیده بگ',
      'url': 'https://wa.me/+989364218681',
      'icon': 'bi-whatsapp'
        ...
        {
            'label': 'تلگرام پدیده بگ',
            'url': 'https://tlgrm.me/+989364218681',
            'icon': 'bi bi-telegram'
        },
        //{
        //    'label': 'آپارات پدیده بگ',
        //    'url': 'https://www.aparat.com/PadidehBagss',
        //    'icon': 'bi-camera-reels'
        //},
        {
            'label': 'دانلود کاتالوگ',
            'url': 'https://padidehbags.com/Catalog',
